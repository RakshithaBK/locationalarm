...
public class OffersMapActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String s = getIntent().getStringExtra("Get_Location_Name");
        searchPlace = s;

        TextView getLocationText = (TextView) findViewById(R.id.getLocationText);
        getLocationText.setText(s);

        ImageView closeActivity = (ImageView) findViewById(R.id.closeMap);
